...
async def transfer_user(
    ...
    if payload.don_vi_id_moi and payload.don_vi_id_moi != don_vi_cu_id:
        # Khoá đánh giá tháng cũ + xoá mềm kê khai nháp + gỡ khỏi báo cáo chưa
        # duyệt. Dùng CHUNG với điều chuyển hàng loạt để hai luồng không lệch
        # nhau — xem `app/core/dieu_chuyen.py`.
        await don_dep_du_lieu_khi_chuyen_don_vi(db, user_id)
