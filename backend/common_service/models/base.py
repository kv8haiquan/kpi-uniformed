"""
common_service/models/base.py
==============================
Base class cho tat ca SQLAlchemy models trong module Common.
...
class Base(DeclarativeBase):
    """DeclarativeBase cho Common service."""
...
class CongChucRef(Base):
    ...
    # ⚠️ KHONG map password_hash — Module common KHONG CAN doc
