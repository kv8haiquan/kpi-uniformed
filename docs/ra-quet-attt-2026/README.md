...
| 2 | Mô tả chức năng, quy trình nghiệp vụ | *(biên soạn từ docs/ hiện có)* | ⏳ Đang soạn |
| 3 | Danh mục SP/CV, tiêu chí, công thức điểm, quy tắc xếp loại | *(xuất từ DB + quy định hiện hành)* | ⏳ Đang soạn |
...
| 9 | Hồ sơ kiểm thử, nghiệm thu, HDSD, cập nhật phiên bản | *(tổng hợp pytest + hướng dẫn)* | ⏳ Đang soạn |
